...
public partial class TestsForApiPages
{
    ...
    [
        ...
        typeof(MudNumericField<double>), typeof(MudForm), typeof(MudAutocomplete<object>), typeof(MudField), typeof(MudFileUpload<object>), typeof(MudToggleGroup<object>), typeof(MudToggleItem<object>),
